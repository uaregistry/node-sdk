...
// EPP result codes (RFC 5730 section 3). Branch on Response.code() / CommandError.eppCode
// with these instead of bare numbers, e.g. `if (err.eppCode === ResultCode.OBJECT_EXISTS)`.
